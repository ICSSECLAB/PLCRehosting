...
/{
 ...
 hbmmc_bnk0: hbmmc_bnk0@0x4000000000ULL { compatible = "qemu:memory-region"; container = <&hbmmc_0_mem>; qemu,ram = <1>; reg = <0x40 0x0 0x2 0x0 0x0 >; };
 ...
 hbmmc_bnk1: hbmmc_bnk1@0x5000000000ULL { compatible = "qemu:memory-region"; container = <&hbmmc_0_mem>; qemu,ram = <1>; reg = <0x50 0x0 0x2 0x0 0x0 >; };
