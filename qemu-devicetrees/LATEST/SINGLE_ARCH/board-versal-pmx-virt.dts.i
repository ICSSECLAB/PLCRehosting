# 1 "board-versal-pmx-virt.dts"
# 1 "<built-in>" 1
# 1 "board-versal-pmx-virt.dts" 2
# 36 "board-versal-pmx-virt.dts"
# 1 "include/memmap/ksb/SSV_FC/ksb-npi-memmap.dtsh" 1
# 37 "board-versal-pmx-virt.dts" 2
...
# 184 "./versal-pmc-npi.dtsi"
 npi_ddrmc_ub0: npi_ddrmc_ub0@0xf67c0000 { doc-limitations = "Only the uB rst is supported"; compatible = "xlnx,versal-ddrmc-ub"; reg = <0x0 0xf67c0000 0x0 0x40000 0x1>; reset-gpios = <&pmc_clk_rst 15 >; #gpio-cells = <1>; gpio-controller; };
 ...
 npi_ddrmc_ub1: npi_ddrmc_ub1@0xf68b0000 { doc-limitations = "Only the uB rst is supported"; compatible = "xlnx,versal-ddrmc-ub"; reg = <0x0 0xf68b0000 0x0 0x40000 0x1>; reset-gpios = <&pmc_clk_rst 15 >; #gpio-cells = <1>; gpio-controller; };
 ...
 npi_ddrmc_ub2: npi_ddrmc_ub2@0xf6dc0000 { doc-limitations = "Only the uB rst is supported"; compatible = "xlnx,versal-ddrmc-ub"; reg = <0x0 0xf6dc0000 0x0 0x40000 0x1>; reset-gpios = <&pmc_clk_rst 15 >; #gpio-cells = <1>; gpio-controller; };
 ...
 npi_ddrmc_ub3: npi_ddrmc_ub3@0xf6eb0000 { doc-limitations = "Only the uB rst is supported"; compatible = "xlnx,versal-ddrmc-ub"; reg = <0x0 0xf6eb0000 0x0 0x40000 0x1>; reset-gpios = <&pmc_clk_rst 15 >; #gpio-cells = <1>; gpio-controller; };
...
&amba_lpd {
 gem0: ethernet@0xf19e0000 { #address-cells = <1>; #size-cells = <0>; #priority-cells = <0>; compatible = "cdns,gem"; interrupts = <39 39>; dma = <&smmu_tbu0>; memattr = <&gem0_memattr_smid>; memattr-write = <&gem0_w_memattr_smid>; reg = <0x0 0xf19e0000 0x0 0x10000 0x0>; num-priority-queues = <2>; reset-gpios = <&crl 1>; power-gpios = <&psm_local 21>; };
 gem1: ethernet@0xf19f0000 { #address-cells = <1>; #size-cells = <0>; #priority-cells = <0>; compatible = "cdns,gem"; interrupts = <41 41>; dma = <&smmu_tbu0>; memattr = <&gem1_memattr_smid>; memattr-write = <&gem1_w_memattr_smid>; reg = <0x0 0xf19f0000 0x0 0x10000 0x0>; num-priority-queues = <2>; reset-gpios = <&crl 2>; power-gpios = <&psm_local 22>; };
...
# 38 "board-versal-pmx-virt.dts" 2
...
# 39 "board-versal-pmx-virt.dts" 2
...
# 48 "board-versal-pmx-virt.dts" 2
# 1 "./versal-psx.dtsi" 1
# 30 "./versal-psx.dtsi"
# 1 "./versal.dtsh" 1
# 31 "./versal.dtsh"
...
/ {
 ...
 smmu_tbu5: tbu5_slave@0 { compatible = "qemu:memory-region"; alias = <&amba_pmc>; reg = <0x0 0x0 0xffffffff 0xffffffff 0xffffffff >; };
 smmu_tbu6: tbu6_slave@0 { compatible = "qemu:memory-region"; alias = <&amba_pmc>; reg = <0x0 0x0 0xffffffff 0xffffffff 0xffffffff >; };
 smmu_tbu7: tbu7_slave@0 { compatible = "qemu:memory-region"; alias = <&amba_pmc>; reg = <0x0 0x0 0xffffffff 0xffffffff 0xffffffff >; };
 smmu_tbu8: tbu8_slave@0 { compatible = "qemu:memory-region"; alias = <&amba_pmc>; reg = <0x0 0x0 0xffffffff 0xffffffff 0xffffffff >; };
 smmu_tbu9: tbu9_slave@0 { compatible = "qemu:memory-region"; alias = <&amba_pmc>; reg = <0x0 0x0 0xffffffff 0xffffffff 0xffffffff >; };
 smmu_tbu10: tbu10_slave@0 { compatible = "qemu:memory-region"; alias = <&amba_pmc>; reg = <0x0 0x0 0xffffffff 0xffffffff 0xffffffff >; };
 smmu_tbu11: tbu11_slave@0 { compatible = "qemu:memory-region"; alias = <&amba_pmc>; reg = <0x0 0x0 0xffffffff 0xffffffff 0xffffffff >; };
 smmu_tbu12: tbu12_slave@0 { compatible = "qemu:memory-region"; alias = <&amba_pmc>; reg = <0x0 0x0 0xffffffff 0xffffffff 0xffffffff >; };
};
...
# 49 "board-versal-pmx-virt.dts" 2
...
# 50 "board-versal-pmx-virt.dts" 2
...
# 51 "board-versal-pmx-virt.dts" 2
