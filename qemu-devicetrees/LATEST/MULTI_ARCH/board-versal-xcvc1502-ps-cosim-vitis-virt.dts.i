# 1 "board-versal-xcvc1502-ps-cosim-vitis-virt.dts"
# 1 "<built-in>" 1
# 1 "board-versal-xcvc1502-ps-cosim-vitis-virt.dts" 2
...
# 1 "./board-versal-xcvc1502-ps-virt.dts" 1
# 10 "./board-versal-xcvc1502-ps-virt.dts"
# 1 "include/versal/memmap/versal-xcvc1502-npi-memmap.dtsi" 1
# 11 "./board-versal-xcvc1502-ps-virt.dts" 2
...
# 12 "./board-versal-xcvc1502-ps-virt.dts" 2


&pmc_tap {
 idcode = <0x04C98093>;
};
# 9 "board-versal-xcvc1502-ps-cosim-vitis-virt.dts" 2
...
# 10 "board-versal-xcvc1502-ps-cosim-vitis-virt.dts" 2
...
# 11 "board-versal-xcvc1502-ps-cosim-vitis-virt.dts" 2
