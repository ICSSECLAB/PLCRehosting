# 1 "board-versal-xqvp1502-ps-cosim-vitis-virt.dts"
# 1 "<built-in>" 1
# 1 "board-versal-xqvp1502-ps-cosim-vitis-virt.dts" 2
...
# 1 "./board-versal-xqvp1502-ps-virt.dts" 1
# 10 "./board-versal-xqvp1502-ps-virt.dts"
# 1 "./board-versal-xcvp1502-ps-virt.dts" 1
...
# 1 "./board-versal-xcvp1202-ps-virt.dts" 1
# 24 "./board-versal-xcvp1202-ps-virt.dts"
# 1 "include/versal/memmap/versal-xcvp1202-npi-memmap.dtsi" 1
# 25 "./board-versal-xcvp1202-ps-virt.dts" 2
# 1 "./versal-cpm5-memmap.dtsh" 1
# 26 "./board-versal-xcvp1202-ps-virt.dts" 2
...
# 1 "./versal-gty-npi.dtsi" 1
 ...
 gtyp_npi_slave_0@0xf6990000 { compatible = "xlnx,xlnx,gtyp_npi_slave"; reg = <0x0 0xf6990000 0x0 0x20000 0x0>; };


 gtyp_npi_slave_1@0xf69f0000 { compatible = "xlnx,xlnx,gtyp_npi_slave"; reg = <0x0 0xf69f0000 0x0 0x20000 0x0>; };


 gtyp_npi_slave_2@0xf6ef0000 { compatible = "xlnx,xlnx,gtyp_npi_slave"; reg = <0x0 0xf6ef0000 0x0 0x20000 0x0>; };





 gtm_npi_slave_0@0xf67f0000 { compatible = "xlnx,xlnx,gtyp_npi_slave"; reg = <0x0 0xf67f0000 0x0 0x20000 0x0>; };


 gtm_npi_slave_1@0xf6850000 { compatible = "xlnx,xlnx,gtyp_npi_slave"; reg = <0x0 0xf6850000 0x0 0x20000 0x0>; };


 gtm_npi_slave_2@0xf68a0000 { compatible = "xlnx,xlnx,gtyp_npi_slave"; reg = <0x0 0xf68a0000 0x0 0x20000 0x0>; };


 gtm_npi_slave_3@0xf68f0000 { compatible = "xlnx,xlnx,gtyp_npi_slave"; reg = <0x0 0xf68f0000 0x0 0x20000 0x0>; };


 gtm_npi_slave_4@0xf6940000 { compatible = "xlnx,xlnx,gtyp_npi_slave"; reg = <0x0 0xf6940000 0x0 0x20000 0x0>; };
...
# 27 "./board-versal-xcvp1202-ps-virt.dts" 2
...
# 29 "./board-versal-xcvp1202-ps-virt.dts" 2

&pmc_tap {
 idcode = <0x04D00093>;
};
# 10 "./board-versal-xcvp1502-ps-virt.dts" 2
...
# 11 "./board-versal-xqvp1502-ps-virt.dts" 2
# 9 "board-versal-xqvp1502-ps-cosim-vitis-virt.dts" 2
...
# 10 "board-versal-xqvp1502-ps-cosim-vitis-virt.dts" 2
...
# 11 "board-versal-xqvp1502-ps-cosim-vitis-virt.dts" 2
