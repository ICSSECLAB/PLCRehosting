# 1 "board-versal-ps-vhk158.dts"
# 1 "<built-in>" 1
# 1 "board-versal-ps-vhk158.dts" 2
# 23 "board-versal-ps-vhk158.dts"
...
# 24 "board-versal-ps-vhk158.dts" 2
...
/{
 ...
 hbmmc_bnk0: hbmmc_bnk0@0x4000000000ULL { compatible = "qemu:memory-region"; container = <&hbmmc_0_mem>; qemu,ram = <2>; reg = <0x40 0x0 0x8 0x0 0x0 >; };
