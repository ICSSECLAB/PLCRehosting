# 1 "board-versal-xcvm2302-ps-cosim-vitis-virt.dts"
# 1 "<built-in>" 1
# 1 "board-versal-xcvm2302-ps-cosim-vitis-virt.dts" 2
...
# 1 "./board-versal-xcvm2302-ps-virt.dts" 1
# 10 "./board-versal-xcvm2302-ps-virt.dts"
# 1 "./board-versal-xcvp1402-ps-virt.dts" 1
# 39 "./board-versal-xcvp1402-ps-virt.dts"
# 1 "include/versal/memmap/versal-xcvp1402-npi-memmap.dtsi" 1
# 40 "./board-versal-xcvp1402-ps-virt.dts" 2
...
# 1 "./versal-gty-npi.dtsi" 1
 ...
 gtyp_npi_slave_0@0xf7560000 { compatible = "xlnx,xlnx,gtyp_npi_slave"; reg = <0x0 0xf7560000 0x0 0x20000 0x0>; };


 gtyp_npi_slave_1@0xf75b0000 { compatible = "xlnx,xlnx,gtyp_npi_slave"; reg = <0x0 0xf75b0000 0x0 0x20000 0x0>; };
# 14 "./versal-gty-npi.dtsi"
 gtm_npi_slave_0@0xf67e0000 { compatible = "xlnx,xlnx,gtyp_npi_slave"; reg = <0x0 0xf67e0000 0x0 0x20000 0x0>; };


 gtm_npi_slave_1@0xf6830000 { compatible = "xlnx,xlnx,gtyp_npi_slave"; reg = <0x0 0xf6830000 0x0 0x20000 0x0>; };


 gtm_npi_slave_2@0xf6880000 { compatible = "xlnx,xlnx,gtyp_npi_slave"; reg = <0x0 0xf6880000 0x0 0x20000 0x0>; };


 gtm_npi_slave_3@0xf68d0000 { compatible = "xlnx,xlnx,gtyp_npi_slave"; reg = <0x0 0xf68d0000 0x0 0x20000 0x0>; };


 gtm_npi_slave_4@0xf6920000 { compatible = "xlnx,xlnx,gtyp_npi_slave"; reg = <0x0 0xf6920000 0x0 0x20000 0x0>; };


 gtm_npi_slave_5@0xf6970000 { compatible = "xlnx,xlnx,gtyp_npi_slave"; reg = <0x0 0xf6970000 0x0 0x20000 0x0>; };


 gtm_npi_slave_6@0xf69c0000 { compatible = "xlnx,xlnx,gtyp_npi_slave"; reg = <0x0 0xf69c0000 0x0 0x20000 0x0>; };


 gtm_npi_slave_7@0xf6a10000 { compatible = "xlnx,xlnx,gtyp_npi_slave"; reg = <0x0 0xf6a10000 0x0 0x20000 0x0>; };


 gtm_npi_slave_8@0xf6a60000 { compatible = "xlnx,xlnx,gtyp_npi_slave"; reg = <0x0 0xf6a60000 0x0 0x20000 0x0>; };


 gtm_npi_slave_9@0xf6ab0000 { compatible = "xlnx,xlnx,gtyp_npi_slave"; reg = <0x0 0xf6ab0000 0x0 0x20000 0x0>; };


 gtm_npi_slave_10@0xf6b00000 { compatible = "xlnx,xlnx,gtyp_npi_slave"; reg = <0x0 0xf6b00000 0x0 0x20000 0x0>; };


 gtm_npi_slave_11@0xf6b50000 { compatible = "xlnx,xlnx,gtyp_npi_slave"; reg = <0x0 0xf6b50000 0x0 0x20000 0x0>; };


 gtm_npi_slave_12@0xf6ba0000 { compatible = "xlnx,xlnx,gtyp_npi_slave"; reg = <0x0 0xf6ba0000 0x0 0x20000 0x0>; };


 gtm_npi_slave_13@0xf6c00000 { compatible = "xlnx,xlnx,gtyp_npi_slave"; reg = <0x0 0xf6c00000 0x0 0x20000 0x0>; };


 gtm_npi_slave_14@0xf7240000 { compatible = "xlnx,xlnx,gtyp_npi_slave"; reg = <0x0 0xf7240000 0x0 0x20000 0x0>; };


 gtm_npi_slave_15@0xf7290000 { compatible = "xlnx,xlnx,gtyp_npi_slave"; reg = <0x0 0xf7290000 0x0 0x20000 0x0>; };


 gtm_npi_slave_16@0xf72e0000 { compatible = "xlnx,xlnx,gtyp_npi_slave"; reg = <0x0 0xf72e0000 0x0 0x20000 0x0>; };


 gtm_npi_slave_17@0xf7330000 { compatible = "xlnx,xlnx,gtyp_npi_slave"; reg = <0x0 0xf7330000 0x0 0x20000 0x0>; };


 gtm_npi_slave_18@0xf7380000 { compatible = "xlnx,xlnx,gtyp_npi_slave"; reg = <0x0 0xf7380000 0x0 0x20000 0x0>; };


 gtm_npi_slave_19@0xf73d0000 { compatible = "xlnx,xlnx,gtyp_npi_slave"; reg = <0x0 0xf73d0000 0x0 0x20000 0x0>; };


 gtm_npi_slave_20@0xf7420000 { compatible = "xlnx,xlnx,gtyp_npi_slave"; reg = <0x0 0xf7420000 0x0 0x20000 0x0>; };


 gtm_npi_slave_21@0xf7470000 { compatible = "xlnx,xlnx,gtyp_npi_slave"; reg = <0x0 0xf7470000 0x0 0x20000 0x0>; };


 gtm_npi_slave_22@0xf74c0000 { compatible = "xlnx,xlnx,gtyp_npi_slave"; reg = <0x0 0xf74c0000 0x0 0x20000 0x0>; };


 gtm_npi_slave_23@0xf7510000 { compatible = "xlnx,xlnx,gtyp_npi_slave"; reg = <0x0 0xf7510000 0x0 0x20000 0x0>; };
...
# 41 "./board-versal-xcvp1402-ps-virt.dts" 2


&amba_fpd{
 /delete-node/ cpm_crcpm@0xfca00000;
 /delete-node/ cpm_pcsr@0xfcff0000;
...
# 11 "./board-versal-xcvm2302-ps-virt.dts" 2

&pmc_tap {
 idcode = <0x04C23093>;
};
# 9 "board-versal-xcvm2302-ps-cosim-vitis-virt.dts" 2
...
# 10 "board-versal-xcvm2302-ps-cosim-vitis-virt.dts" 2
# 1 "./versal-vitis.dtsi" 1
# 33 "./versal-vitis.dtsi"
/ {
 /delete-node/ ddr_2@0x800000000ULL;
 /delete-node/ ddr_3@0x50000000000ULL;
 ddr_4_mem: memory@0x10000000000ULL {
  compatible = "qemu:memory-region";
  device_type = "memory";
  container = <&amba>;
 };

 ddr_ch1_mem: memory@0x50000000000ULL {
  compatible = "qemu:memory-region";
  device_type = "memory";
  container = <&amba>;
 };
 ddr_ch1_2_mem: memory@0x58000000000ULL {
  compatible = "qemu:memory-region";
  device_type = "memory";
  container = <&amba>;
 };

 ddr_ch2_mem: memory@0x60000000000ULL {
  compatible = "qemu:memory-region";
  device_type = "memory";
  container = <&amba>;
 };

 ddr_ch2_2_mem: memory@0x68000000000ULL {
  compatible = "qemu:memory-region";
  device_type = "memory";
  container = <&amba>;
 };

 ddr_ch3_mem: memory@0x70000000000ULL {
  compatible = "qemu:memory-region";
  device_type = "memory";
  container = <&amba>;
 };

 ddr_ch3_2_mem: memory@0x78000000000ULL {
  compatible = "qemu:memory-region";
  device_type = "memory";
  container = <&amba>;
 };
};
# 11 "board-versal-xcvm2302-ps-cosim-vitis-virt.dts" 2
