# 1 "board-versal-xcvp1002-ps-cosim-vitis-virt.dts"
# 1 "<built-in>" 1
# 1 "board-versal-xcvp1002-ps-cosim-vitis-virt.dts" 2
...
# 1 "./board-versal-xcvp1002-ps-virt.dts" 1
# 10 "./board-versal-xcvp1002-ps-virt.dts"
# 1 "./board-versal-xcvp1052-ps-virt.dts" 1
# 24 "./board-versal-xcvp1052-ps-virt.dts"
# 1 "include/versal/memmap/versal-xcvp1052-npi-memmap.dtsi" 1
# 25 "./board-versal-xcvp1052-ps-virt.dts" 2
...
# 184 "./versal-pmc-npi.dtsi"
 ...
 npi_ddrmc_ub1: npi_ddrmc_ub1@0xf62e0000 { doc-limitations = "Only the uB rst is supported"; compatible = "xlnx,versal-ddrmc-ub"; reg = <0x0 0xf62e0000 0x0 0x40000 0x1>; reset-gpios = <&pmc_clk_rst 15 >; #gpio-cells = <1>; gpio-controller; };
 npi_ddrmc_main1: npi_ddrmc_main1@0xf6320000 { doc-limitations = "Just a stub"; compatible = "xlnx,versal-ddrmc-main"; reg = <0x0 0xf6320000 0x0 0x10000 0x1>; reset-gpios = <&pmc_clk_rst 15 >; };
 npi_ddrmc_noc1: npi_ddrmc_noc1@0xf6270000 { doc-limitations = "Just a stub"; compatible = "xlnx,versal-ddrmc-noc"; reg = <0x0 0xf6270000 0x0 0x20000 0xffffffff>; reset-gpios = <&pmc_clk_rst 15 >; };
...
# 14 "./versal-gty-npi.dtsi"
 gtm_npi_slave_0@0xf6660000 { compatible = "xlnx,xlnx,gtyp_npi_slave"; reg = <0x0 0xf6660000 0x0 0x20000 0x0>; };


 gtm_npi_slave_1@0xf66c0000 { compatible = "xlnx,xlnx,gtyp_npi_slave"; reg = <0x0 0xf66c0000 0x0 0x20000 0x0>; };


 gtm_npi_slave_2@0xf6710000 { compatible = "xlnx,xlnx,gtyp_npi_slave"; reg = <0x0 0xf6710000 0x0 0x20000 0x0>; };


 gtm_npi_slave_3@0xf6760000 { compatible = "xlnx,xlnx,gtyp_npi_slave"; reg = <0x0 0xf6760000 0x0 0x20000 0x0>; };


 gtm_npi_slave_4@0xf67b0000 { compatible = "xlnx,xlnx,gtyp_npi_slave"; reg = <0x0 0xf67b0000 0x0 0x20000 0x0>; };


 gtm_npi_slave_5@0xf6800000 { compatible = "xlnx,xlnx,gtyp_npi_slave"; reg = <0x0 0xf6800000 0x0 0x20000 0x0>; };


 gtm_npi_slave_6@0xf6850000 { compatible = "xlnx,xlnx,gtyp_npi_slave"; reg = <0x0 0xf6850000 0x0 0x20000 0x0>; };


 gtm_npi_slave_7@0xf68a0000 { compatible = "xlnx,xlnx,gtyp_npi_slave"; reg = <0x0 0xf68a0000 0x0 0x20000 0x0>; };


 gtm_npi_slave_8@0xf68f0000 { compatible = "xlnx,xlnx,gtyp_npi_slave"; reg = <0x0 0xf68f0000 0x0 0x20000 0x0>; };


 gtm_npi_slave_9@0xf6c70000 { compatible = "xlnx,xlnx,gtyp_npi_slave"; reg = <0x0 0xf6c70000 0x0 0x20000 0x0>; };


 gtm_npi_slave_10@0xf6cd0000 { compatible = "xlnx,xlnx,gtyp_npi_slave"; reg = <0x0 0xf6cd0000 0x0 0x20000 0x0>; };


 gtm_npi_slave_11@0xf6d20000 { compatible = "xlnx,xlnx,gtyp_npi_slave"; reg = <0x0 0xf6d20000 0x0 0x20000 0x0>; };
...
# 26 "./board-versal-xcvp1052-ps-virt.dts" 2


&pmc_tap {
 idcode = <0x04C18093>;
};
# 11 "./board-versal-xcvp1002-ps-virt.dts" 2

&pmc_tap {
 idcode = <0x04C1B093>;
};
# 9 "board-versal-xcvp1002-ps-cosim-vitis-virt.dts" 2
...
# 10 "board-versal-xcvp1002-ps-cosim-vitis-virt.dts" 2
...
# 11 "board-versal-xcvp1002-ps-cosim-vitis-virt.dts" 2
