# 1 "board-versal-ps-cosim-vc-p-a2197-00.dts"
# 1 "<built-in>" 1
# 1 "board-versal-ps-cosim-vc-p-a2197-00.dts" 2
# 30 "board-versal-ps-cosim-vc-p-a2197-00.dts"
# 1 "./board-versal-ps-vc-p-a2197-00.dts" 1
# 30 "./board-versal-ps-vc-p-a2197-00.dts"
# 1 "./board-versal-ps-virt.dts" 1
# 32 "./board-versal-ps-virt.dts"
/dts-v1/;

# 1 "./versal-npi-memmap.dtsh" 1
# 35 "./board-versal-ps-virt.dts" 2
...
# 31 "./board-versal-ps-vc-p-a2197-00.dts" 2
...
&ps_i2c0 {
 i2cswitch@74 {
  ...
  i2c@0 {
   ...
   tps53671rsbt@0x42 { compatible = "i2c-dev-dummy"; reg = <0x42>; };
   tps53671rsbt@0x43 { compatible = "i2c-dev-dummy"; reg = <0x43>; };
   tps53671rsbt@0x44 { compatible = "i2c-dev-dummy"; reg = <0x44>; };
   tps53671rsbt@0x45 { compatible = "i2c-dev-dummy"; reg = <0x45>; };
  };
  i2c@1 {
   #address-cells = <1>;
   #size-cells = <0>;
   ...
   ina226@0xc0 { compatible = "i2c-dev-dummy"; reg = <0xc0>; };
   ina226@0x07 { compatible = "i2c-dev-dummy"; reg = <0x07>; };
   ina226@0x08 { compatible = "i2c-dev-dummy"; reg = <0x08>; };
   ina226@0x09 { compatible = "i2c-dev-dummy"; reg = <0x09>; };
   ina226@0x0a { compatible = "i2c-dev-dummy"; reg = <0x0a>; };
  };
  i2c@2 {
   #address-cells = <1>;
   #size-cells = <0>;
   ...
   tps53671rsbt@0x0D { compatible = "i2c-dev-dummy"; reg = <0x0D>; };
   tps53671rsbt@0x0E { compatible = "i2c-dev-dummy"; reg = <0x0E>; };
   tps53671rsbt@0x0F { compatible = "i2c-dev-dummy"; reg = <0x0F>; };
   tps53671rsbt@0x10 { compatible = "i2c-dev-dummy"; reg = <0x10>; };
   tps53671rsbt@0x11 { compatible = "i2c-dev-dummy"; reg = <0x11>; };
   tps53671rsbt@0x12 { compatible = "i2c-dev-dummy"; reg = <0x12>; };
   tps53671rsbt@0x13 { compatible = "i2c-dev-dummy"; reg = <0x13>; };
   tps53671rsbt@0x14 { compatible = "i2c-dev-dummy"; reg = <0x14>; };
   tps53671rsbt@0x15 { compatible = "i2c-dev-dummy"; reg = <0x15>; };
   tps53671rsbt@0x16 { compatible = "i2c-dev-dummy"; reg = <0x16>; };
   tps53671rsbt@0x17 { compatible = "i2c-dev-dummy"; reg = <0x17>; };
   tps53671rsbt@0x19 { compatible = "i2c-dev-dummy"; reg = <0x19>; };
   tps53671rsbt@0x1a { compatible = "i2c-dev-dummy"; reg = <0x1a>; };
   tps53671rsbt@0x1b { compatible = "i2c-dev-dummy"; reg = <0x1b>; };
   tps53671rsbt@0x1c { compatible = "i2c-dev-dummy"; reg = <0x1c>; };
   tps53671rsbt@0x1d { compatible = "i2c-dev-dummy"; reg = <0x1d>; };
   tps53671rsbt@0x1e { compatible = "i2c-dev-dummy"; reg = <0x1e>; };
   tps53671rsbt@0x1f { compatible = "i2c-dev-dummy"; reg = <0x1f>; };
  };
  i2c@3 {
   #address-cells = <1>;
   #size-cells = <0>;
   ...
   ina226@0x40 { compatible = "i2c-dev-dummy"; reg = <0x40>; };
   ina226@0x41 { compatible = "i2c-dev-dummy"; reg = <0x41>; };
   ina226@0x42 { compatible = "i2c-dev-dummy"; reg = <0x42>; };
   ina226@0x43 { compatible = "i2c-dev-dummy"; reg = <0x43>; };
   ina226@0x44 { compatible = "i2c-dev-dummy"; reg = <0x44>; };
   ina226@0x45 { compatible = "i2c-dev-dummy"; reg = <0x45>; };
   ina226@0x46 { compatible = "i2c-dev-dummy"; reg = <0x46>; };
   ina226@0x47 { compatible = "i2c-dev-dummy"; reg = <0x47>; };
   ina226@0x48 { compatible = "i2c-dev-dummy"; reg = <0x48>; };
   ina226@0x49 { compatible = "i2c-dev-dummy"; reg = <0x49>; };
   ina226@0x4a { compatible = "i2c-dev-dummy"; reg = <0x4a>; };
   ina226@0x4b { compatible = "i2c-dev-dummy"; reg = <0x4b>; };
   ina226@0x4c { compatible = "i2c-dev-dummy"; reg = <0x4c>; };
   ina226@0x4d { compatible = "i2c-dev-dummy"; reg = <0x4d>; };
   ina226@0x4e { compatible = "i2c-dev-dummy"; reg = <0x4e>; };
  };
  i2c@4 {
   #address-cells = <1>;
   #size-cells = <0>;
...
# 31 "board-versal-ps-cosim-vc-p-a2197-00.dts" 2
...
# 32 "board-versal-ps-cosim-vc-p-a2197-00.dts" 2
