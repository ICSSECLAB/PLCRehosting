# 1 "board-versal-psx-virt.dts"
# 1 "<built-in>" 1
# 1 "board-versal-psx-virt.dts" 2
# 38 "board-versal-psx-virt.dts"
...
/ {
 cpus {
  ...
  #size-cells = <0>;
  cpu0: apu_cpu@0 {
   compatible = "cortex-a78-arm-cpu"; device_type = "cpu"; arm,ccsidr0 = <0x701fe00a>; arm,ccsidr1 = <0x201fe012>; reg = <0>; core-count = <2>; arm,reset-hivecs = <1>; arm,rvbar = <0xffff0000>; arm,reset-cbar = <0xf9040000>; mr = <&amba_apu>; memory = <&amba_apu>; qemu,halt = <0x1>;
  ...
  cpu1: apu_cpu@1 {
   compatible = "cortex-a78-arm-cpu"; device_type = "cpu"; arm,ccsidr0 = <0x701fe00a>; arm,ccsidr1 = <0x201fe012>; reg = <1>; core-count = <2>; arm,reset-hivecs = <1>; arm,rvbar = <0xffff0000>; arm,reset-cbar = <0xf9040000>; mr = <&amba_apu>; memory = <&amba_apu>; qemu,halt = <0x1>;
...
# 39 "board-versal-psx-virt.dts" 2
