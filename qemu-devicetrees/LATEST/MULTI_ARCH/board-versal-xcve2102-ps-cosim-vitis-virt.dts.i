# 1 "board-versal-xcve2102-ps-cosim-vitis-virt.dts"
# 1 "<built-in>" 1
# 1 "board-versal-xcve2102-ps-cosim-vitis-virt.dts" 2
...
# 1 "./board-versal-xcve2102-ps-virt.dts" 1
# 11 "./board-versal-xcve2102-ps-virt.dts"
# 1 "include/versal/memmap/versal-xcve2102-npi-memmap.dtsi" 1
# 12 "./board-versal-xcve2102-ps-virt.dts" 2
...
# 217 "./versal-pmc-npi.dtsi"
 npi_me: npi_me@MM_NPI_ME_NPI_0 {
  ...
  reg = <0x0 0xf6300000 0x0 0x10000 0x1>;
...
# 14 "./board-versal-xcve2102-ps-virt.dts" 2
# 9 "board-versal-xcve2102-ps-cosim-vitis-virt.dts" 2
...
# 10 "board-versal-xcve2102-ps-cosim-vitis-virt.dts" 2
...
&amba_pmc_pl {
 rp_pmc_npi@0 {
  ...
  reg = <
   ...
   0x0 0xf6300000 0x0 0x10000 0x2

   >;
  remote-ports = <&cosim_rp_0 60>;
 };
};
# 11 "board-versal-xcve2102-ps-cosim-vitis-virt.dts" 2
