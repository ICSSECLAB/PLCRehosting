# 1 "board-versal-ps-cosim-vitis-vek280.dts"
# 1 "<built-in>" 1
# 1 "board-versal-ps-cosim-vitis-vek280.dts" 2
# 10 "board-versal-ps-cosim-vitis-vek280.dts"
# 1 "./board-versal-ps-cosim-vitis-vek280_es_revb.dts" 1
...
# 1 "./board-versal-ps-vek280.dts" 1
# 19 "./board-versal-ps-vek280.dts"
# 1 "./board-versal-xcve2802-ps-virt.dts" 1
# 16 "./board-versal-xcve2802-ps-virt.dts"
# 1 "./board-versal-xcvc2802-ps-virt.dts" 1
# 17 "./board-versal-xcvc2802-ps-virt.dts"
# 1 "include/versal/memmap/versal-xcvc2802-npi-memmap.dtsi" 1
# 18 "./board-versal-xcvc2802-ps-virt.dts" 2

# 1 "./versal-cpm5-memmap.dtsh" 1
# 20 "./board-versal-xcvc2802-ps-virt.dts" 2
...
# 217 "./versal-pmc-npi.dtsi"
 npi_me: npi_me@MM_NPI_ME_NPI_0 {
  ...
  reg = <0x0 0xf6d10000 0x0 0x10000 0x1>;
...
# 1 "./versal-gty-npi.dtsi" 1
 ...
 gtyp_npi_slave_0@0xf6720000 { compatible = "xlnx,xlnx,gtyp_npi_slave"; reg = <0x0 0xf6720000 0x0 0x20000 0x0>; };


 gtyp_npi_slave_1@0xf6780000 { compatible = "xlnx,xlnx,gtyp_npi_slave"; reg = <0x0 0xf6780000 0x0 0x20000 0x0>; };


 gtyp_npi_slave_2@0xf67d0000 { compatible = "xlnx,xlnx,gtyp_npi_slave"; reg = <0x0 0xf67d0000 0x0 0x20000 0x0>; };


 gtyp_npi_slave_3@0xf6d50000 { compatible = "xlnx,xlnx,gtyp_npi_slave"; reg = <0x0 0xf6d50000 0x0 0x20000 0x0>; };
...
# 21 "./board-versal-xcvc2802-ps-virt.dts" 2
...
&amba_fpd {
 cpm5_crx: cpm5_crx@0xdc0000 {
  ...
  reg = <0x0 (0xfc000000 + 0xdc0000) 0x0 0x10000 0x0>;
 };
 ...
 cpm5_slcr_secure@0xde0000 {
  ...
  reg = <0x0 (0xfc000000 + 0xde0000) 0x0 0x10000 0x0>;
 };

 cpm5_gtyp_cfg@0xd00000 {
  compatible = "xlnx,gtyp_npi_slave";
  reg = <0x0 (0xfc000000 + 0xd00000) 0x0 0x20000 0x0>;
 };

 cpm5_gtyp_cfg@0xd20000 {
  compatible = "xlnx,gtyp_npi_slave";
  reg = <0x0 (0xfc000000 + 0xd20000) 0x0 0x20000 0x0>;
 };

 cpm5_gtyp_cfg@0xd40000 {
  compatible = "xlnx,gtyp_npi_slave";
  reg = <0x0 (0xfc000000 + 0xd40000) 0x0 0x20000 0x0>;
 };

 cpm5_gtyp_cfg@0xd60000 {
  compatible = "xlnx,gtyp_npi_slave";
  reg = <0x0 (0xfc000000 + 0xd60000) 0x0 0x20000 0x0>;
 };
};
# 23 "./board-versal-xcvc2802-ps-virt.dts" 2
# 1 "./versal-vdu.dtsi" 1
# 17 "./versal-vdu.dtsi"
&amba_pmc_pl {


 vdu_npi_0@0xf6820000 { compatible = "xlnx,vdu_npi"; reg = <0x0 0xf6820000 0x0 0x20000 0x0>; };


 vdu_npi_1@0xf6870000 { compatible = "xlnx,vdu_npi"; reg = <0x0 0xf6870000 0x0 0x20000 0x0>; };


 vdu_npi_2@0xf68c0000 { compatible = "xlnx,vdu_npi"; reg = <0x0 0xf68c0000 0x0 0x20000 0x0>; };


 vdu_npi_3@0xf6920000 { compatible = "xlnx,vdu_npi"; reg = <0x0 0xf6920000 0x0 0x20000 0x0>; };


};
# 24 "./board-versal-xcvc2802-ps-virt.dts" 2

&pmc_tap {
 idcode = <0x04CD0093>;
};
# 17 "./board-versal-xcve2802-ps-virt.dts" 2
# 20 "./board-versal-ps-vek280.dts" 2
...
# 10 "./board-versal-ps-cosim-vitis-vek280_es_revb.dts" 2
...
# 11 "./board-versal-ps-cosim-vitis-vek280_es_revb.dts" 2
...
&amba_pmc_pl {
 rp_pmc_npi@0 {
  ...
  reg = <
   ...
   0x0 0xf6d10000 0x0 0x10000 0x2

   >;
  remote-ports = <&cosim_rp_0 60>;
 };
};
# 12 "./board-versal-ps-cosim-vitis-vek280_es_revb.dts" 2
# 11 "board-versal-ps-cosim-vitis-vek280.dts" 2
