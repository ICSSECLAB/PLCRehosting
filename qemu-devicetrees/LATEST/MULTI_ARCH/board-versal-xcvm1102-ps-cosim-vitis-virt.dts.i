# 1 "board-versal-xcvm1102-ps-cosim-vitis-virt.dts"
# 1 "<built-in>" 1
# 1 "board-versal-xcvm1102-ps-cosim-vitis-virt.dts" 2
...
# 1 "./board-versal-xcvm1102-ps-virt.dts" 1
# 11 "./board-versal-xcvm1102-ps-virt.dts"
...
# 12 "./board-versal-xcvm1102-ps-virt.dts" 2

&pmc_tap {
 idcode = <0x04CC9093>;
};
# 9 "board-versal-xcvm1102-ps-cosim-vitis-virt.dts" 2
...
# 10 "board-versal-xcvm1102-ps-cosim-vitis-virt.dts" 2
...
&amba_pmc_pl {
 rp_pmc_npi@0 {
  ...
  reg = <
   ...
   0x0 0xf6420000 0x0 0x10000 0x2

   >;
  remote-ports = <&cosim_rp_0 60>;
 };
};
# 11 "board-versal-xcvm1102-ps-cosim-vitis-virt.dts" 2
