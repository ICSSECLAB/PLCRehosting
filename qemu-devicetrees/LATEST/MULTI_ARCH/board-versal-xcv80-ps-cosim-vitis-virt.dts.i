# 1 "board-versal-xcv80-ps-cosim-vitis-virt.dts"
# 1 "<built-in>" 1
# 1 "board-versal-xcv80-ps-cosim-vitis-virt.dts" 2
...
# 1 "./board-versal-xcv80-ps-virt.dts" 1
# 10 "./board-versal-xcv80-ps-virt.dts"
# 1 "./board-versal-xcvh1782-ps-virt.dts" 1
# 11 "./board-versal-xcvh1782-ps-virt.dts"
# 1 "include/versal/memmap/versal-xcvh1782-npi-memmap.dtsi" 1
# 12 "./board-versal-xcvh1782-ps-virt.dts" 2
...
# 13 "./board-versal-xcvh1782-ps-virt.dts" 2
...
/{
 hbmmc_0_mem: memory@0x4000000000ULL {
  compatible = "qemu:memory-region";
  device_type = "memory";
  container = <&amba>;
 };

 hbmmc_bnk0: hbmmc_bnk0@0x4000000000ULL { compatible = "qemu:memory-region"; container = <&hbmmc_0_mem>; qemu,ram = <2>; reg = <0x40 0x0 0x4 0x0 0x0 >; };


 hbmmc_1_mem: memory@0x5000000000ULL {
  compatible = "qemu:memory-region";
  device_type = "memory";
  container = <&amba>;
 };

 hbmmc_bnk1: hbmmc_bnk1@0x5000000000ULL { compatible = "qemu:memory-region"; container = <&hbmmc_0_mem>; qemu,ram = <2>; reg = <0x50 0x0 0x4 0x0 0x0 >; };

};
# 11 "./board-versal-xcv80-ps-virt.dts" 2
# 9 "board-versal-xcv80-ps-cosim-vitis-virt.dts" 2
...
# 10 "board-versal-xcv80-ps-cosim-vitis-virt.dts" 2
...
# 11 "board-versal-xcv80-ps-cosim-vitis-virt.dts" 2
