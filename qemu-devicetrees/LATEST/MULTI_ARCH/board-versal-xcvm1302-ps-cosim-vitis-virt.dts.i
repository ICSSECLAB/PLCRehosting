# 1 "board-versal-xcvm1302-ps-cosim-vitis-virt.dts"
# 1 "<built-in>" 1
# 1 "board-versal-xcvm1302-ps-cosim-vitis-virt.dts" 2
...
# 1 "./board-versal-xcvm1302-ps-virt.dts" 1
...
# 1 "./board-versal-xcvm1402-ps-virt.dts" 1
# 10 "./board-versal-xcvm1402-ps-virt.dts"
# 1 "include/versal/memmap/versal-xcvm1402-npi-memmap.dtsi" 1
# 11 "./board-versal-xcvm1402-ps-virt.dts" 2
...
# 184 "./versal-pmc-npi.dtsi"
 ...
 npi_ddrmc_ub2: npi_ddrmc_ub2@0xf6990000 { doc-limitations = "Only the uB rst is supported"; compatible = "xlnx,versal-ddrmc-ub"; reg = <0x0 0xf6990000 0x0 0x40000 0x1>; reset-gpios = <&pmc_clk_rst 15 >; #gpio-cells = <1>; gpio-controller; };
 npi_ddrmc_main2: npi_ddrmc_main2@0xf69d0000 { doc-limitations = "Just a stub"; compatible = "xlnx,versal-ddrmc-main"; reg = <0x0 0xf69d0000 0x0 0x10000 0x1>; reset-gpios = <&pmc_clk_rst 15 >; };
 npi_ddrmc_noc2: npi_ddrmc_noc2@0xf6920000 { doc-limitations = "Just a stub"; compatible = "xlnx,versal-ddrmc-noc"; reg = <0x0 0xf6920000 0x0 0x20000 0xffffffff>; reset-gpios = <&pmc_clk_rst 15 >; };


 npi_ddrmc_ub3: npi_ddrmc_ub3@0xf6b00000 { doc-limitations = "Only the uB rst is supported"; compatible = "xlnx,versal-ddrmc-ub"; reg = <0x0 0xf6b00000 0x0 0x40000 0x1>; reset-gpios = <&pmc_clk_rst 15 >; #gpio-cells = <1>; gpio-controller; };
 npi_ddrmc_main3: npi_ddrmc_main3@0xf6b40000 { doc-limitations = "Just a stub"; compatible = "xlnx,versal-ddrmc-main"; reg = <0x0 0xf6b40000 0x0 0x10000 0x1>; reset-gpios = <&pmc_clk_rst 15 >; };
 npi_ddrmc_noc3: npi_ddrmc_noc3@0xf6a90000 { doc-limitations = "Just a stub"; compatible = "xlnx,versal-ddrmc-noc"; reg = <0x0 0xf6a90000 0x0 0x20000 0xffffffff>; reset-gpios = <&pmc_clk_rst 15 >; };
...
# 12 "./board-versal-xcvm1402-ps-virt.dts" 2


&pmc_tap {
 idcode = <0x04C08093>;
};
# 10 "./board-versal-xcvm1302-ps-virt.dts" 2

&pmc_tap {
 idcode = <0x04C09093>;
};
# 9 "board-versal-xcvm1302-ps-cosim-vitis-virt.dts" 2
...
# 10 "board-versal-xcvm1302-ps-cosim-vitis-virt.dts" 2
...
# 11 "board-versal-xcvm1302-ps-cosim-vitis-virt.dts" 2
