# 1 "board-versal-ps-cosim-vitis-vck190.dts"
# 1 "<built-in>" 1
# 1 "board-versal-ps-cosim-vitis-vck190.dts" 2
# 30 "board-versal-ps-cosim-vitis-vck190.dts"
# 1 "./board-versal-ps-cosim-vck190.dts" 1
# 29 "./board-versal-ps-cosim-vck190.dts"
# 1 "./board-versal-ps-vck190.dts" 1
# 29 "./board-versal-ps-vck190.dts"
...
# 30 "./board-versal-ps-vck190.dts" 2


/{
 ddr_3: ddr_3@0x50000000000ULL { compatible = "qemu:memory-region"; container = <&ddr_3_mem>; qemu,ram = <2>; reg = <0x500 0x0 0x2 0x0 0x0 >; };

};
# 30 "./board-versal-ps-cosim-vck190.dts" 2
...
# 31 "./board-versal-ps-cosim-vck190.dts" 2
# 31 "board-versal-ps-cosim-vitis-vck190.dts" 2
...
&amba_pmc_pl {
 rp_pmc_npi@0 {
  ...
  reg = <
   ...
   0x0 0xf70a0000 0x0 0x10000 0x2
...
# 32 "board-versal-ps-cosim-vitis-vck190.dts" 2
