# 1 "board-zynqmp-kd240.dts"
# 1 "<built-in>" 1
# 1 "board-zynqmp-kd240.dts" 2
...
# 9 "board-zynqmp-kd240.dts" 2
# 1 "./board-zynqmp-sck-kd.dtsi" 1
# 23 "./board-zynqmp-sck-kd.dtsi"
&i2c1 {
 eeprom1: eeprom@51 {
  compatible = "at,24c08";
  reg = <0x51>;
